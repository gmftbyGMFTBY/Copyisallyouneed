...
# CUDA_VISIBLE_DEVICES=6 python gpt2_test.py --dataset en_wiki --model gpt2 --decoding_method greedy &
CUDA_VISIBLE_DEVICES=0 python gpt2_test.py --dataset en_wiki --model gpt2 --decoding_method nucleus_sampling &
...
# CUDA_VISIBLE_DEVICES=1 python gpt2_test.py --dataset wikitext103 --model gpt2 --decoding_method greedy &
