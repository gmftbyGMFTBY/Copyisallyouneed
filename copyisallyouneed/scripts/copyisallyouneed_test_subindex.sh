...
# CUDA_VISIBLE_DEVICES=6 python copyisallyouneed_test_subindex.py --dataset en_wiki --model copyisallyouneed --decoding_method nucleus_sampling --split_rate 0.3 &
