...
# wikitext103
# CUDA_VISIBLE_DEVICES=2 python mauve/test_roberta_v2.py --device 2 --test_path raw_files/gpt2_result.json &
# CUDA_VISIBLE_DEVICES=6 python mauve/test_roberta_v2.py --device 6 --test_path raw_files/gpt2_result_greedy.json &
# CUDA_VISIBLE_DEVICES=0 python mauve/test_roberta_v2.py --device 0 --test_path raw_files/copyisallyouneed_result.json &
# CUDA_VISIBLE_DEVICES=7 python mauve/test_roberta_v2.py --device 7 --test_path raw_files/copyisallyouneed_result_greedy.json &
# CUDA_VISIBLE_DEVICES=1 python mauve/test_roberta_v2.py --device 1 --test_path raw_files/neurlab_gpt2_result_greedy.json &
# CUDA_VISIBLE_DEVICES=4 python mauve/test_roberta_v2.py --device 4 --test_path raw_files/neurlab_gpt2_result_nucleus_sampling.json &
# CUDA_VISIBLE_DEVICES=2 python mauve/test_roberta_v2.py --device 2 --test_path raw_files/knnlm_result_greedy_full.json &
# CUDA_VISIBLE_DEVICES=7 python mauve/test_roberta_v2.py --device 7 --test_path raw_files/knnlm_result_nucleus_sampling_full.json &
# CUDA_VISIBLE_DEVICES=0 python mauve/test_roberta_v2.py --device 0 --test_path raw_files/retro_result_greedy.json &
# CUDA_VISIBLE_DEVICES=6 python mauve/test_roberta_v2.py --device 6 --test_path raw_files/retro_result_sampling.json &
