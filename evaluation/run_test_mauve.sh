...
python $evaluate_file_name --device 7 --test_path raw_files/knnlm_result_nucleus_sampling_full.json &
...
CUDA_VISIBLE_DEVICES=2 python $evaluate_file_name --device 2 --test_path raw_files/knnlm_result_greedy_full.json &
CUDA_VISIBLE_DEVICES=7 python $evaluate_file_name --device 7 --test_path raw_files/knnlm_result_nucleus_sampling_full.json &
...
<<COMMENT
python $evaluate_file_name --device 2 --test_path raw_files/lawmt_gpt2_result_greedy.json &
python $evaluate_file_name --device 2 --test_path raw_files/lawmt_gpt2_result_nucleus_sampling.json &
...
# en-wiki
<<COMMENT
python $evaluate_file_name --device 2 --test_path raw_files/en_wiki_gpt2_result_greedy.json &
